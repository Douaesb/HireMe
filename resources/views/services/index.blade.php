        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            @foreach ($services as $service)
                <div class="bg-white rounded-lg shadow-lg p-8">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mt-4">Categorie : {{ $service->category->nomCat }}</h3>
                    <h3 class="text-xl font-bold text-gray-600 mt-4">{{ $service->titre }}</h3>
                    <p class="text-gray-500 text-sm mt-2">{{ $service->description }}</p>
                    <div class="flex items-center justify-between mt-4">
                        <span class="text-gray-900 font-bold text-lg">Prix : {{ $service->prix }}$</span>
                        <div class="flex items-center text-green-500">
                            ...
                            <span class="ml-1 leading-none"> {{ $service->datePublication }}</span>
                        </div>
                    </div>
                    <div>
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5">
                    <form class="max-w-md mx-auto" method="post" action="{{ route('service.store') }}">
                        @csrf
                        @method('post')
                        ...
                        <div class="relative z-0 w-full mb-5 group">
                            <input type="text" name="prix" id=""
                                ...
                                placeholder=" " required />
                            <label for=""
                                class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Prix</label>
                        </div>
                        <div class="relative z-0 w-full mb-5 group">
                        ...
                        <div class="relative z-0 w-full mb-5 group">
                            <input type="tel" pattern="[0-9]{10}" name="tel" id=""
                                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                placeholder=" " required />
                            <label for=""
